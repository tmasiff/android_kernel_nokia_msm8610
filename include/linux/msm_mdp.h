...
#define MSMFB_LOW_POWER_MODE_ON       _IO(MSMFB_IOCTL_MAGIC, 169)
#define MSMFB_LOW_POWER_MODE_OFF      _IO(MSMFB_IOCTL_MAGIC, 170)
#define MSMFB_SELFTEST_RESULT_GET     _IOR(MSMFB_IOCTL_MAGIC, 171, unsigned int *)
#define MSMFB_SELFTEST_TE_PIN_STATUS_GET      _IOR(MSMFB_IOCTL_MAGIC, 172, unsigned int *)
